const demoRoutes = [
  ...
  },
  {
    href: "/control/test",
    label: "Control shell",
    description: "Toss-entry control route",
  },
  {
    href: "/control/new",
    label: "New match",
    description: "Create a server-backed control room",
  },
  {
    ...
    <main className="flex flex-1 items-center justify-center px-8 py-16">
      <section className="w-full max-w-3xl">
        ...
        <h1 className="text-5xl font-semibold tracking-normal text-white">
          Demos and route shells
        </h1>
        <p className="mt-6 max-w-2xl text-xl leading-8 text-zinc-300">
          Developer surfaces for checking display states and control rooms.
        </p>
